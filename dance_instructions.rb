...
def lasso 
  ...
  puts "Raise right forearm so that it pints straight up, and whip it in small circles to th beat of the song, as if you were a cowboy holding a rope lasso. This movement is repeated eight times as well."
end
def overall 
  puts "Assume stance"
  puts "Bust a move"
